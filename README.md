...
- **40** балів за _лекційну_&thinsp; складову курсу:
	...
	- **30** балів за модулі, по **15** балів за кожний з двох (див. [_контрольні роботи_](exams/README.md)).
...
- **20** балів за езкамен/залік (див. [_контрольні запитання_](control/README.md)).
